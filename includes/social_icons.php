...
<?php endif; ?>
	...
	<li class="et-social-icon et-social-linkedin">
		<a href="https://www.linkedin.com/in/christian-behrends-97968350/" class="icon">
			<span><?php esc_html_e( 'linkedin', 'Divi' ); ?></span>
		</a>
	</li>

	<li class="custom-social-icon icon-xing2">
		<a href="https://www.xing.com/profile/Christian_Behrends3" class="icon">
			<span><?php esc_html_e( 'xing2', 'webdevtrust' ); ?></span>
		</a>
	</li>
